...
And now, a few years later, I got the urge to make a game rooted in this world. Inspired by the FromSoftware Souls games, I wanted to make my own souls-like. However, such a project could take years to even start looking like something. So I started by making a small prototype for the combat system. Which I will most probably throw away. But anyway. Here is a short video of how it looks like:

{% include embed/video.html src='/assets/soulslike/souls_prototype.mp4' %}
